...
function setLang(lang){
  ...
  const superbarTitleEl=document.querySelector('.i18n-superbar-title');if(superbarTitleEl)superbarTitleEl.textContent=dict.superbarTitle;
